...
target_dataset = datasets.ImageFolder(
    f'/home/Domain_Generalization/data/PACS/kfold/{args.target}', 
...
for name in args.source:
    dataset = datasets.ImageFolder(
        f'/home/Domain_Generalization/data/PACS/kfold/{name}', 
...
for now_epoch in range(args.epochs):
    ...
    for it, batch in enumerate(source_loader):
        ...
        class_logit = model(data, labels_labels_flip, False, now_epoch)
